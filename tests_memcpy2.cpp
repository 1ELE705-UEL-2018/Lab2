...
TEST(memcpy2, ArraysTamanhoUmNum1ApenasRetorno)
{
	...
	test_memcpy_apenas_retorno(v1, v2, 1, memcpy2);
}
...
TEST(memcpy2, ArraysTamanhoUmNum1Completo)
{
	...
	test_memcpy_completo(v1, v2, 1, memcpy2);
}
...
TEST(memcpy2, ArraysTamanhoUmNum0)
{
	...
	test_memcpy_completo(v1, v2, 0, memcpy2);
	ASSERT_EQ(0x13, v1[0]);
}
...
TEST(memcpy2, ArraysTamanhoDoisNum2)
{
	...
	test_memcpy_completo(v1, v2, 2, memcpy2);
}
...
TEST(memcpy2, ArraysTamanhoCincoNum5)
{
	...
	test_memcpy_completo(v1, v2, 5, memcpy2);
}
...
TEST(memcpy2, ArraysTamanhoCincoNum3NaoUltrapassaFimDoArray)
{
	...
	test_memcpy_completo(v1, v2, 3, memcpy2);
	ASSERT_EQ(0x67, v1[3]);
	ASSERT_EQ(0x89, v1[4]);
}