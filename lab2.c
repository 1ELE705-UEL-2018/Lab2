...
{
	// Digite aqui o seu codigo do exercicio 1
}

void troca2(int* pa, int* pb)
{
	// Digite aqui o seu codigo do exercicio 2
}

int resolve_eq_2grau(double a, double b, double c, double* x1, double* x2)
{
	// Digite aqui o seu codigo do exercicio 4
	return 0;
}
...
{
	// Digite aqui o seu codigo do exercicio 5(d) usando vetores
	return NULL;
}
...
{
	// Digite aqui o seu codigo do exercicio 5(f) usando vetores
	return NULL;
}
